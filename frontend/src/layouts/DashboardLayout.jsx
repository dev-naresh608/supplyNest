...
export const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 flex flex-col md:flex-row antialiased selection:bg-indigo-100 selection:text-indigo-900">
      ...
      {/* Mobile Top Nav */}
      <div className="md:hidden flex items-center justify-between px-4 py-3 bg-white/95 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40 shadow-xs">
        ...
        <>
          ...
          <div className="md:hidden fixed top-14 left-0 right-0 max-h-[calc(100vh-3.5rem)] overflow-y-auto bg-white border-b border-slate-200 p-4 space-y-2 z-50 shadow-2xl">
            ...
            <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-3 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-xs font-semibold truncate text-slate-900">{user?.fullName || `${user?.firstName} ${user?.lastName}`}</h4>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="hidden md:flex h-16 bg-white/80 backdrop-blur-md border-b border-slate-200/90 px-6 items-center justify-between sticky top-0 z-20">
        ...
        <main className="flex-1 p-3.5 sm:p-6 md:p-8 overflow-y-auto overflow-x-hidden bg-[#f8fafc]">
